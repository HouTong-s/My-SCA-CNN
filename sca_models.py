...
resnet34_encoder_dim = 512
resnet101_encoder_dim = 2048
...
class Encoder(nn.Module):
    ...
    def forward(self, images):
        ...
        """
        feature_map = self.resnet(images)  # (batch_size, resnet34_encoder_dim, image_size/32, image_size/32)
        #out = self.adaptive_pool(out)  # (batch_size, resnet34_encoder_dim, encoded_image_size, encoded_image_size)
        #out = out.permute(0, 2, 3, 1)  # (batch_size, encoded_image_size, encoded_image_size, resnet34_encoder_dim)
        return feature_map
...
class Spatial_attention(nn.Module):
    ...
    def __init__(self,feature_map,decoder_dim,K = resnet34_encoder_dim):
        """
    ...
    def forward(self, feature_map, decoder_hidden):
        ...
        :return: alpha
        """
        V_map = feature_map.view(feature_map.shape[0],resnet34_encoder_dim,-1) 
...
#         print("alpha",alpha.shape)
        ...
        feature_map = feature_map.view(feature_map.shape[0],resnet34_encoder_dim,-1) 
...
class Channel_wise_attention(nn.Module):
    ...
    def forward(self, feature_map, decoder_hidden):
        ...
        :return: alpha
        """
        V_map = feature_map.view(feature_map.shape[0],resnet34_encoder_dim,-1) .mean(dim=2)
...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size,encoder_out_shape=[1,resnet34_encoder_dim,8,8], K=resnet34_encoder_dim,encoder_dim=resnet34_encoder_dim, dropout=0.5):
        """
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths):
        ...
        for t in range(max(decode_lengths)):
            ...
            attention_weighted_encoding = attention_weighted_encoding.view(attention_weighted_encoding.shape[0],resnet34_encoder_dim,7,7)
